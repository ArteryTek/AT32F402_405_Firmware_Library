...
void qspi_gpio_init(void)
{
  ...
  CRM->ahben3 |= 0x00000002;

  /* enable the gpio pin clock */
  CRM->ahben1 |= 0x00000006;

  /* configure the gpio */
  GPIOB->cfgr = 0x000080A0;
  GPIOB->odrvr = 0x000040D0;
  GPIOB->muxl = 0xB0000B00;

  GPIOC->cfgr = 0x008A0800;
  GPIOC->odrvr = 0x00450400;
  GPIOC->muxl = 0x00B00000;
  GPIOC->muxh = 0x0000B0BB;
}
