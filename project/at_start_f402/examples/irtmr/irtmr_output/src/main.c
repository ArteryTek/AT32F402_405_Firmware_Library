...
/** @addtogroup 402_IRTMR_output IRTMR_output
  * @{
  */
...
int main(void)
{
  ...
  tmr_channel_value_set(TMR10, TMR_SELECT_CHANNEL_1, c1dt_val);
  ...
  tmr_channel_value_set(TMR11, TMR_SELECT_CHANNEL_1, c2dt_val);
