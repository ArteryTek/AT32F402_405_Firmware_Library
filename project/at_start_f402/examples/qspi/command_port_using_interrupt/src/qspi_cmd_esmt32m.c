...
/** @addtogroup 402_QSPI_command_port_using_interrupt
  * @{
  */
...
/**
  * @brief  set qspi_state_is_busy
  * @param  none
  * @retval none
  */
void qspi_command_set_busy()
{
  qspi_state_is_busy = SET;
}

/**
  * @brief  reset qspi_state_is_busy
  * @param  none
  * @retval none
  */
void qspi_command_not_busy()
{
  qspi_state_is_busy = RESET;
}

/**
  * @brief  return qspi_state_is_busy
  * @param  none
  * @retval the new state of qspi_state_is_busy (SET or RESET).
  */
flag_status qspi_command_is_busy(void)
{
  return qspi_state_is_busy;
}
