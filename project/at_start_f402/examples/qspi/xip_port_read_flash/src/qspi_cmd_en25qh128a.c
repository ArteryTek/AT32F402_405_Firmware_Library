...
/** @addtogroup 402_QSPI_xip_port_read_flash
  * @{
  */
...
0x6B,QSPI_XIP_ADDRLEN_3_BYTE,QSPI_OPERATE_MODE_114,8,0x32,QSPI_XIP_ADDRLEN_3_BYTE,QSPI_OPERATE_MODE_114,0,QSPI_XIPW_SEL_MODED,0x7F,0x1F,QSPI_XIPR_SEL_MODET,0x7F,0x10};
