...
/** @addtogroup 405_QSPI_command_port_using_dma_in_qpi_mode QSPI_command_port_using_dma_in_qpi_mode
  * @{
  */
...
void qspi_config(void)
{
  ...
  gpio_init(GPIOA, &gpio_init_struct);
  gpio_pin_mux_config(GPIOA, GPIO_PINS_SOURCE9, GPIO_MUX_11);
  ...
  gpio_init_struct.gpio_pins = GPIO_PINS_6;
  gpio_init(GPIOB, &gpio_init_struct);
  gpio_pin_mux_config(GPIOB, GPIO_PINS_SOURCE6, GPIO_MUX_11);
}
