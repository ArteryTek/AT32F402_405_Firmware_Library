...
/** @addtogroup 405_I2S_fullduplex_dma I2S_fullduplex_dma
  * @{
  */
...
int main(void)
{
  ...
  /* enable i2sf slave dma to get and fill data */
  dma_channel_enable(DMA1_CHANNEL4, TRUE);
  dma_channel_enable(DMA1_CHANNEL3, TRUE);
  
  /* enable spi_i2s master dma to get and fill data */
