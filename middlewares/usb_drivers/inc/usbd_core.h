...
typedef struct
{
  ...
  usbd_desc_t *(*get_hs_device_configuration)(void);                 /*!< get hs device configuration callback */
...
typedef struct
{
  ...
  uint32_t                               setup_buffer[12];           /*!< usb setup request buffer */
  ...
  uint32_t                               dma_en;                     /*!< usb dma enable */
  uint8_t                                test_mode;
}usbd_core_type;
