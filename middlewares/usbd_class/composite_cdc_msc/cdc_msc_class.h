...
/**
  ...
  */
#define USBD_FS_MAXPACKET_SIZE                0x40
#define USBD_CDC_MSC_IN_MAXPACKET_SIZE        0x40
#define USBD_CDC_MSC_OUT_MAXPACKET_SIZE       0x40

#define USBD_HS_MAXPACKET_SIZE                0x100
#define USBD_HS_CDC_MSC_IN_MAXPACKET_SIZE     USBD_HS_MAXPACKET_SIZE
#define USBD_HS_CDC_MSC_OUT_MAXPACKET_SIZE    USBD_HS_MAXPACKET_SIZE
