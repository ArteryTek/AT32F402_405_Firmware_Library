...
#define USBD_HS_WINUSB_MAXPACKET_SIZE        0x200
#define USBD_HS_WINUSB_IN_MAXPACKET_SIZE     USBD_HS_WINUSB_MAXPACKET_SIZE
#define USBD_HS_WINUSB_OUT_MAXPACKET_SIZE    USBD_HS_WINUSB_MAXPACKET_SIZE
