...
/**
  ...
  */
#define USBD_FS_VCPKYBRD_MAXPACKET_SIZE           0x40
#define USBD_VCPKYBRD_IN_MAXPACKET_SIZE           USBD_FS_VCPKYBRD_MAXPACKET_SIZE
#define USBD_VCPKYBRD_OUT_MAXPACKET_SIZE          USBD_FS_VCPKYBRD_MAXPACKET_SIZE

#define USBD_HS_VCPKYBRD_MAXPACKET_SIZE           0x100
#define USBD_HS_VCPKYBRD_IN_MAXPACKET_SIZE        USBD_HS_VCPKYBRD_MAXPACKET_SIZE
#define USBD_HS_VCPKYBRD_OUT_MAXPACKET_SIZE       USBD_HS_VCPKYBRD_MAXPACKET_SIZE
