...
ALIGNED_HEAD static uint8_t g_usbd_configuration[USBD_MOUSE_CONFIG_DESC_SIZE] ALIGNED_TAIL =
{
  ...
  #pragma data_alignment=4
#endif
ALIGNED_HEAD static uint8_t g_usbd_hs_configuration[USBD_MOUSE_CONFIG_DESC_SIZE] ALIGNED_TAIL =
{
  USB_DEVICE_CFG_DESC_LEN,               /* bLength: configuration descriptor size */
  USB_DESCIPTOR_TYPE_CONFIGURATION,      /* bDescriptorType: configuration */
  LBYTE(USBD_MOUSE_CONFIG_DESC_SIZE),    /* wTotalLength: bytes returned */
  ...
  LBYTE(USBD_MOUSE_IN_MAXPACKET_SIZE),
  HBYTE(USBD_MOUSE_IN_MAXPACKET_SIZE),   /* wMaxPacketSize: maximum packe size this endpoint */
  MOUSE_HS_BINTERVAL_TIME,                  /* bInterval: interval for polling endpoint for data transfers */
};
  ...
  #pragma data_alignment=4
#endif
ALIGNED_HEAD static uint8_t g_usbd_other_speed[USBD_MOUSE_CONFIG_DESC_SIZE] ALIGNED_TAIL =
{
  USB_DEVICE_CFG_DESC_LEN,               /* bLength: configuration descriptor size */
  USB_DESCIPTOR_TYPE_CONFIGURATION,      /* bDescriptorType: configuration */
  LBYTE(USBD_MOUSE_CONFIG_DESC_SIZE),    /* wTotalLength: bytes returned */
