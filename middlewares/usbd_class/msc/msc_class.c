...
static usb_sts_type class_init_handler(void *udev)
{
  ...
  {
      /* open in endpoint */
    usbd_ept_open(pudev, USBD_MSC_BULK_IN_EPT, EPT_BULK_TYPE, USBD_HS_OUT_MAXPACKET_SIZE);

    /* open out endpoint */
    usbd_ept_open(pudev, USBD_MSC_BULK_OUT_EPT, EPT_BULK_TYPE, USBD_HS_OUT_MAXPACKET_SIZE);
