...
#define USBD_PRINTER_MAXPACKET_SIZE      0x40
#define USBD_PRINTER_IN_MAXPACKET_SIZE   USBD_PRINTER_MAXPACKET_SIZE
#define USBD_PRINTER_OUT_MAXPACKET_SIZE  USBD_PRINTER_MAXPACKET_SIZE

#define USBD_HS_PRINTER_MAXPACKET_SIZE      0x100
#define USBD_HS_PRINTER_IN_MAXPACKET_SIZE   USBD_HS_PRINTER_MAXPACKET_SIZE
#define USBD_HS_PRINTER_OUT_MAXPACKET_SIZE  USBD_HS_PRINTER_MAXPACKET_SIZE
